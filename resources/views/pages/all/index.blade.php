        ...
        <form action="{{ route('home.store') }}" method="POST">
            ...
            <table class="table table-bordered"> 
                ...
                <tr>
                    ...
                    <td >
                        <input type="number" class="form-control" name="sibling">
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td >
                        <input type="text" class="form-control" name="achievment1">
                        <input type="text" class="form-control mt-2" name="achievment2">
                    </td>
                </tr>
                </div>
                <!-- DATA ORTU -->
                <div> 
                    ...
                    <tr>
                        ...
                        <div class="form-group row">
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="father_birth_place">
                            </div>
                            <div class="col-md-8">
                                <input type="date" class="form-control" name="father_birth_date">
                            </div>
                        </div> 
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td >
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name="father_salary">
                                </div>
                            </div>   
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <div class="form-group row">
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="mother_birth_place">
                            </div>
                            <div class="col-md-8">
                                <input type="date" class="form-control" name="mother_birth_date">
                            </div>
                        </div> 
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td >
                            <select class="form-control" name="mother_last_education">
                                <option value="Tidak Sekolah">Tidak Sekolah</option>
                                <option value="SD">SD</option>
                                <option value="SMP">SMP</option>
                                <option value="SMA">SMA</option>
                    ...
                    <tr>
                        ...
                        <td >
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name="mother_salary">
                                </div>
                            </div>   
                        </td>
                    </tr>
                ...
                <div>
                    ...
                    <tr>
                        ...
                        <td >
                            <input type="text" class="form-control" name="wali_name">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <div class="form-group row">
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="wali_birth_place">
                            </div>
                            <div class="col-md-8">
                                <input type="date" class="form-control" name="wali_birth_date">
                            </div>
                        </div> 
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td >
                            <select class="form-control" name="wali_last_education">
                                <option value="Tidak Sekolah">Tidak Sekolah</option>
                                <option value="SD">SD</option>
                                <option value="SMP">SMP</option>
                                <option value="SMA">SMA</option>
                    ...
                    <tr>
                        ...
                        <td >
                            <input type="text" class="form-control" name="wali_job">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td >
                            <input type="text" class="form-control" name="wali_address">
                        </td>
                    </tr>
                </div>
            </table>
